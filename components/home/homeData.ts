...
export const testimonials = [
  ...
  { name: 'Soren Whitaker', role: 'Operations Leader', company: '', image: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?auto=format&fit=crop&w=160&q=80', challenge: 'Important decisions depended on inconsistent views of the business.', transformation: 'Shared, trusted workflows made reporting and operational decisions easier to align.', quote: 'When everyone can work from the same trusted foundation, decisions move with much less friction.' },
  ...
  { name: 'Nivaan Perera', role: 'Product Strategy Lead', company: '', image: 'https://images.unsplash.com/photo-1519345182560-3f2917c472ef?auto=format&fit=crop&w=160&q=80', challenge: 'Business teams needed answers without waiting for another preparation cycle.', transformation: 'More usable information helped product and leadership teams move from questions to action with greater confidence.', quote: 'We spend less time debating which version is right and more time deciding what to do next.' },
] as const;
