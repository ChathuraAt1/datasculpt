      ...
      <Reveal>
        <header className="grid items-end gap-10 lg:grid-cols-[1fr_0.8fr]">
          ...
          <div>
            ...
            <div className="mt-7 flex flex-wrap items-center gap-2.5 border-t border-brand-100/80 pt-5">
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://www.google.com/s2/favicons?domain=crunchbase.com&sz=32";
                  }}
                />
              ...
              >
                <img
                  ...
                  onError={(e) => {
                    e.currentTarget.src =
                      "https://www.google.com/s2/favicons?domain=f6s.com&sz=32";
                  }}
                />
                <span>F6S</span>
                <ArrowUpRight size={13} className="text-slate-400" />
